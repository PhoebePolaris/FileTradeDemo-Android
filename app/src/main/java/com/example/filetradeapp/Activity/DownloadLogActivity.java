...
import com.example.filetradeapp.Presenter.DownloadLogPresenterImpl;
...
public class DownloadLogActivity extends AppCompatActivity implements Contract.IDownloadLogView {
    private Toolbar toolbar;
    private TextView toolbarTitle;
    private View view;

    private static DownloadLogPresenterImpl presenter = new DownloadLogPresenterImpl();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitle.setText("下载记录");
        presenter.doDownloadLog();

        recyclerView=(RecyclerView)findViewById(R.id.recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(DownloadLogActivity.this,LinearLayoutManager.VERTICAL,false));
    ...
    @Override
    public void onDownloadLog(List<FileBean> list) {
        if(list!=null){
            cardList = list;
            recyclerAdapter.resetCardList(cardList);
        }
        else {
            Toast.makeText(DownloadLogActivity.this, "获得列表失败", Toast.LENGTH_SHORT).show();
