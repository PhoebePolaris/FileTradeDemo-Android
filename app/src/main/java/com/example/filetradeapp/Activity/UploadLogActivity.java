...
import com.example.filetradeapp.Presenter.UploadLogPresenterImpl;
...
public class UploadLogActivity extends AppCompatActivity implements Contract.IUploadLogView {
    private Toolbar toolbar;
    private TextView toolbarTitle;
    private View view;

    private static UploadLogPresenterImpl presenter = new UploadLogPresenterImpl();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter.doUploadLog();

        recyclerView=(RecyclerView)findViewById(R.id.recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(UploadLogActivity.this,LinearLayoutManager.VERTICAL,false));
    ...
    @Override
    public void onUploadLog(List<FileBean> list) {
        if(list!=null){
            cardList = list;
            recyclerAdapter.resetCardList(cardList);
        }
        else {
            Toast.makeText(UploadLogActivity.this, "获得列表失败", Toast.LENGTH_SHORT).show();
